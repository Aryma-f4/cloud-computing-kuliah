  ...
  return (
    <div className="mx-auto flex min-h-dvh max-w-md flex-col justify-center gap-6 p-5 bg-neutral-50 dark:bg-neutral-950">
      ...
      <div className="text-center space-y-1 mt-4">
        <h1 className="text-2xl font-bold tracking-tight text-neutral-900 dark:text-white">Presensi Kehadiran</h1>
        <p className="text-sm text-neutral-500 dark:text-neutral-400">Pastikan data Anda sudah benar</p>
      </div>
