...
import {
  ...
  Activity, ChevronRight, Wifi, Map as MapIcon, LogOut, ChevronLeft,
}
from "lucide-react";
      ...
      <div className="mx-auto flex min-h-dvh max-w-md flex-col bg-[#F2F2F7] dark:bg-neutral-950 rounded-2xl">
        ...
        <div className="relative bg-primary dark:bg-[#4a7da0] px-6 pt-14 pb-10 overflow-hidden rounded-2xl">
          ...
          <div className="relative">
            ...
            <p className="mt-1 text-sm text-white/60">E-Absen · Course ID Manual</p>
          </div>
        </div>
        ...
        <div className="flex-1 px-4 py-6 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              ...
              <div>
                <p className="text-sm font-semibold text-neutral-900 dark:text-neutral-100 leading-tight">Cek Status</p>
          ...
          <button
            ...
            disabled={!isReady}
            className={[
              "w-full flex items-center justify-between rounded-2xl bg-white dark:bg-neutral-900 px-5 py-4 text-left",
              "shadow-sm ring-1 ring-black/5 dark:ring-white/5 transition-all duration-200",
              !isReady
                ? "opacity-50 cursor-not-allowed"
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm font-semibold text-neutral-900 dark:text-neutral-100 leading-tight">GPS & Tracking</p>
          ...
          <button
            onClick={handleLogout}
            className="w-full flex items-center justify-between rounded-2xl bg-red-50 dark:bg-red-900/20 px-5 py-4 text-left ring-1 ring-red-100 dark:ring-red-900/40 transition-all hover:bg-red-100 dark:hover:bg-red-900/30 active:scale-[0.98]"
          >
            <div className="flex items-center gap-4">
